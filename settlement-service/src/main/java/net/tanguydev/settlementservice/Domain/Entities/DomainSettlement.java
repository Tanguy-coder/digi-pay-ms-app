...
public class DomainSettlement {
    ...
    public List<DomainSettlementEntry> getEntries() { return entries; }
    public void setEntries(List<DomainSettlementEntry> entries) { this.entries = entries; }
}
